...
public class CinemaHallService {
    ...
    /**
     * Konstruktør for CinemaHallService. Initialiserer CinemaHallDAO med databaseforbindelse.
     */
    public CinemaHallService() {
        try {
            ...
            e.printStackTrace();
            System.err.println("Feil ved opprettelse av CinemaHallDAO i CinemaHallService.");
        }
    }
